...
<h3>09-21 회의내용<h3>
- Select 페이지, Campus 페이지, CampusDetail 페이지 퍼블리싱 및 디자인 완료 보고, 추가로 시간이 남아서 선택 페이지까지 완료 보고
- TensorFlow 기능 추가 및 인공지능 사진 학습(정확도를 위해 학습은 계속 시킬 예정)
- 추가 사항 의논하였으나 추가 사항 의견은 없었음.
